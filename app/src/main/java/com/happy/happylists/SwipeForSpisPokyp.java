...
/**
 * Created by lukyanova on 20.11.15.
 */
public class SwipeForSpisPokyp implements View.OnTouchListener {
     ...
     */
    public SwipeForSpisPokyp(ListView listView, DismissCallbacks callbacks) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (Math.abs(deltaX) > mSlop+50 && mSwiping) {
                    // Swipe Right to Left!!!
                  //  if (deltaX < 0) {
                        dismiss = true;
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (Math.abs(deltaX) < mSlop+50) {
                    /* yslovie (deltaX < 0) ybiraet sdvig vpravo*/
                  //  if (deltaX < 0) {
                        mSwiping = true;
